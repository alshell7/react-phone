...
[![React 18.3 and 19](https://img.shields.io/badge/React-18.3%20%7C%2019-63dca8?style=flat-square)](https://react.dev/)
...
The supplied [Publish workflow](https://github.com/alshell7/react-phone/blob/main/.github/workflows/publish.yml) runs `npx jsr publish` on pushes to `main`, using the linked repository's OIDC identity. Keep `package.json` and `jsr.json` versions aligned; JSR versions are immutable. The [Pages workflow](https://github.com/alshell7/react-phone/blob/main/.github/workflows/pages.yml) deploys Starlight and the playground together. **[Release workflow and site build](https://alshell7.github.io/react-phone/development/)**
