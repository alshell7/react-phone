// Generated from src/components/elevenlabs/orb-shader.ts. Run npm run package:build; do not edit.
// Copyright (c) 2025 ElevenLabs Inc. MIT license; see THIRD_PARTY_NOTICES.md.
// Unmodified ElevenLabs UI Orb shaders (React wrapper adapted in orb.tsx).
