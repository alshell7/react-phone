// Generated from src/core/types.ts. Run npm run package:build; do not edit.
...
export type ConnectionStatus = "disconnected" | "connecting" | "registered" | "reconnecting" | "error";
/** Only one call is active per PhoneClient. Additional INVITEs receive 486 Busy. */
export type CallStatus = "idle" | "requesting-microphone" | "dialing" | "ringing" | "incoming" | "answering" | "active" | "held" | "ended";
export type MicrophoneStatus = "unknown" | "requesting" | "granted" | "denied" | "unavailable";
...
export interface PhoneError {
  code: "configuration" | "connection" | "registration" | "microphone" | "call" | "transfer" | "audio" | "unsupported";
  message: string;
}
...
export type PhoneEventType = "connection" | "incoming" | "outgoing" | "answered" | "disconnected" | "muted" | "held" | "dtmf" | "transfer-started" | "transferred" | "error";
